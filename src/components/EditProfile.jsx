    ...
    <>
      <div className="fixed z-50 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <div className="inset-0 fixed transition-opacity">
          ...
          >
            <div className="flex justify-between px-6 pt-5 pb-2">
              <label
                htmlFor="name"
                className="block font-medium text-x1 text-ascent-1 text-left"
              >
                Edit Profile
              </label>
            ...
            >
              <TextInput
                ...
                register={register("firstName", {
                  required: "firstName do not match",
                })}
              ...
              <TextInput
                ...
                register={register("profession", {
                  required: "Profession do not match",
                })}
              ...
              />
              <label
                className="flex items-center gap-1 text-base text-ascent-2 hover:text-ascent-1 curser-pointer my-4"
                htmlFor="imgUpload"
              >
                <input
                  type="file"
